  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_range_start: "!bg-[#8cc63f] !text-white hover:!bg-[#7ab535]",
        day_range_end: "!bg-[#8cc63f] !text-white hover:!bg-[#7ab535]",
        day_range_middle: "!rounded-none !bg-transparent !text-neutral-800 hover:!bg-[#f0f9e8]",
